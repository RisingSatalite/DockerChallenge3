...
-- Create a new user for the api to interact with the database
CREATE USER 'userprime'@'%' IDENTIFIED BY 'secureaccess';

-- Grant permissions to the user
GRANT ALL PRIVILEGES ON mydatabase.* TO 'userprime'@'%';
